#ifndef OPENCL_POWERFLOW_POWER_SYSTEM_H
#define OPENCL_POWERFLOW_POWER_SYSTEM_H

#include <vector>
#include <complex>

#include "Power_System_Element_Types.h"
#include "Power_System_Element.h"


class PowerSystem {

	opps::SystemElement<BUS> busData;
	opps::SystemElement<BRANCH> branchData;
...
#endif //OPENCL_POWERFLOW_POWER_SYSTEM_H
